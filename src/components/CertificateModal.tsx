...
import { X, Printer, ShieldAlert, Award } from "lucide-react";
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm print:p-0 print:bg-white">
      <div className="relative w-full max-w-4xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-200 print:shadow-none print:border-0 print:rounded-none">
        ...
        <div className="p-8 md:p-12 print:p-0">
          <div className="relative overflow-hidden rounded-xl border-[6px] border-double border-lani-gold bg-amber-50/20 p-8 text-center md:p-16 shadow-inner">
            ...
            <div className="max-w-2xl mx-auto space-y-6 md:space-y-8">
              ...
              <div>
                <h3 className="font-serif text-3xl font-extrabold text-lani-navy md:text-4xl underline decoration-lani-gold/40 decoration-wavy underline-offset-8">
